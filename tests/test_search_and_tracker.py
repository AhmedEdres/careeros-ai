...
class TestScoreAndFilter:
    ...
    def test_direct_tax_title_gets_priority_bonus(self):
        ...
        assert any("Direct title-family evidence" in r for r in direct_result.reasons)
    ...
    def test_direct_operations_title_gets_priority_bonus(self):
        ...
        assert any("Direct target-family title priority" in a[0] for a in result.adjustments)
